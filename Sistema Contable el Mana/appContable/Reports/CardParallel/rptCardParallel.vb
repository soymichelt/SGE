...
Public Class rptCardParallel
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "appContable.rptCardParallel.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCardParallel
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCardParallel = New rptCardParallel()
        rpt.Site = Me.Site
        Return rpt
    End Function
