...
Public Class rptAccountList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "appContable.rptAccountList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAccountList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAccountList = New rptAccountList()
        rpt.Site = Me.Site
        Return rpt
    End Function
