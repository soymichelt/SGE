...
Public Class rptCardAuxiliar
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "appContable.rptCardAuxiliar.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCardAuxiliar
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCardAuxiliar = New rptCardAuxiliar()
        rpt.Site = Me.Site
        Return rpt
    End Function
