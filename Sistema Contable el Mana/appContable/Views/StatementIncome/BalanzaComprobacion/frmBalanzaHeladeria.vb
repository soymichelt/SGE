...
Public Class frmBalanzaHeladeria

    Dim FormLoad As Boolean = False


    Sub List()
        Config.LoadState("Balanza heladeria cargando...")

        Try
            dtRegistro.DataSource = (From c In BalanzaComprobacion.Balanza2(dtpInicio.Value.ToShortDateString & " 00:00:00", dtpFinal.Value.ToShortDateString & " 23:59:59") Select c.IdCuenta, c.Reg, c.Nivel, c.CodigoCompleto, c.Descripcion, c.DebeInicial, c.HaberInicial, c.DebeMes, c.HaberMes, c.DebeSaldo, c.HaberSaldo).ToList
    ...
    Private Sub btImprimir_Click(sender As Object, e As EventArgs) Handles btImprimir.Click
        Try
            Dim rpt As New rptBalanzaComprobacionHeladeria
            ...
            rpt.SetDataSource((From c In BalanzaComprobacion.Balanza2(dtpInicio.Value.ToShortDateString & " 00:00:00", dtpFinal.Value.ToShortDateString & " 23:59:59") Select c.IdCuenta, c.Reg, c.Nivel, Codigo = c.CodigoCompleto, c.Descripcion, c.DebeInicial, c.HaberInicial, c.DebeMes, c.HaberMes, c.DebeSaldo, c.HaberSaldo).ToList)
