...
Public Class frmBalanceGeneralRestaurante
        ...
        Try
            ...
            If dtRegistro.ColumnCount > 0 Then
                ...
                With dtRegistro
                    ...
                    .Columns(7).HeaderText = "Columna 3" : .Columns(7).Width = 115 : .Columns(7).DefaultCellStyle.Format = Config.fm
    ...
    Sub Grid()
        dtRegistro.DataSource = (From c In (New List(Of entBalanceGeneral)) Select c.IdCuenta, c.Reg, c.Nivel, c.CodigoCompleto, c.Descripcion, c.Col1, c.Col2, c.Col3).ToList
        txtItem.Value = 0
        With dtRegistro
            .Columns(0).Visible = False
            .Columns(1).HeaderText = vbNewLine & "Registrada" & vbNewLine : .Columns(1).Width = 120
    ...
    Private Sub frmBalanzaHeladeria_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.txtItem.Value = 0
    ...
    Private Sub frmBalanzaHeladeria_Resize(sender As Object, e As EventArgs) Handles MyBase.Resize
    ...
    Private Sub btImprimir_Click(sender As Object, e As EventArgs) Handles btImprimir.Click
        Try
            Dim rpt As New rptBalanceGeneralRestaurante
            ...
            rpt.SetDataSource((From c In BalanceGeneral.Balance3(dtpInicio.Value.ToShortDateString & " 00:00:00", dtpFinal.Value.ToShortDateString & " 23:59:59") Select c.IdCuenta, c.Reg, c.Nivel, Codigo = c.CodigoCompleto, c.Descripcion, c.Col1, c.Col2, c.Col3).ToList)
