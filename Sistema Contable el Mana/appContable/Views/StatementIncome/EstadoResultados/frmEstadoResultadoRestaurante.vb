...
Public Class frmEstadoResultadoRestaurante


    Dim FormLoad As Boolean = False

    Sub List()
        Config.LoadState("Estado de resultados restaurante cargando...")
    ...
    Private Sub btImprimir_Click(sender As Object, e As EventArgs) Handles btImprimir.Click
        Try
            Dim rpt As New rptEstadoResultadosRestaurante
            ...
            rpt.SetDataSource((From c In EstadoResultados.Estado3(dtpInicio.Value.ToShortDateString & " 00:00:00", dtpFinal.Value.ToShortDateString & " 23:59:59") Select c.IdCuenta, c.Reg, c.Nivel, Codigo = c.CodigoCompleto, c.Descripcion, c.Col1, c.Col2).ToList)
